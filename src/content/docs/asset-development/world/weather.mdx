...
description: "Control sky appearance, celestial bodies, clouds, fog, lighting, and particle effects for dynamic weather conditions."
---
...
- [Particle Systems](/asset-development/vfx/particles/) - Particle effects
- [Audio Effects](/asset-development/audio/effects/) - Weather audio (reverb)
