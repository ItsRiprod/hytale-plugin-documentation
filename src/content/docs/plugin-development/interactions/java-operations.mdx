...
Most custom interactions can be created using [asset-based JSON definitions](/plugin-development/interactions/custom-interactions/). Only use Java Operations when you need:
...
- [Custom Interactions (Asset-Based)](/plugin-development/interactions/custom-interactions/) - JSON-based interactions
- [Interaction System](/plugin-development/interactions/overview/) - System overview
