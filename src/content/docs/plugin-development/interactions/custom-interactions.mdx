...
{/* [VERIFIED: 2026-01-24] - Updated with Update 2 interaction types */}
...
- [Java Interaction Operations](/plugin-development/interactions/java-operations/) - Create custom Operation types in Java
