...
import blockbenchRequired from "../../../../../public/images/tutorials/blockbench/blockbench_required_install.png";
...
<Aside type="caution" title="Package Manager Warning">
  ...
  detect those installations. ![Hytale stating the
  requirement](/images/tutorials/blockbench/blockbench_required_install.png) *I
  haven't been able to get this working personally - any advice would be
  appreciated for getting this to work on Linux!*
</Aside>
